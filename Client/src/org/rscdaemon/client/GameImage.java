...
public class GameImage implements ImageProducer, ImageObserver {
	...
	public void drawPicture(int x, int y, Sprite picture) {
		try {
			int l = x + y * menuDefaultWidth;
			int i1 = 0;
			int j1 = picture.getHeight();
			int k1 = picture.getWidth();
			...
			method235(imagePixelArray, picture.getPixels(), 0, i1, l, k1, j1, l1, i2, byte0);
		}
		catch (Exception e) {
            ...
            for (int offset = 0; offset < string.length(); offset++)
                if (string.charAt(offset) == '@' && offset + 4 < string.length() && string.charAt(offset + 4) == '@') {
                    if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("red"))
                        colour = 0xff0000;
                    else if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("adm")) // Yellow Crown
                        spriteClip4(x - 12, y - 16, 30, 20, 2339, -256, 0, 0, false);
                    else if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("mod")) // Grey Crown
                        spriteClip4(x - 12, y - 16, 30, 20, 2339, -2302756, 0, 0, false);
                    else if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("pmd")) // Green Crown
                        spriteClip4(x - 12, y - 16, 30, 20, 2339, -13382656, 0, 0, false);
                    else if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("evt")) // Blue Crown
                        spriteClip4(x - 12, y - 16, 30, 20, 2339, -10245124, 0, 0, false);
					else if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("dev")) // Red Crown
						spriteClip4(x - 12, y - 16, 30, 20, 2339, 13369344, 0, 0, false);
					else if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("blk")) // Black Crown
						spriteClip4(x - 12, y - 16, 30, 20, 2339, 2500134, 0, 0, false);
					else if (string.substring(offset + 1, offset + 4).equalsIgnoreCase("pnk")) // Pink Crown
				...
				if (string.charAt(offset) == '#' && offset + 4 < string.length() && string.charAt(offset + 4) == '#' && string.substring(offset + 1, offset + 2).equalsIgnoreCase("f")) {
					String str = string.substring(offset + 2, offset + 4);
					Sprite spr = mudclient.flags.get(str.toUpperCase());
					if((str != null) && (str.length() == 2) && (spr != null)) {
						this.drawPicture(x + 3, y - 11 + 1, spr);
						x += 21;
						offset += 4;
					}
				} else
                if (string.charAt(offset) == '#' && offset + 4 < string.length() && string.charAt(offset + 4) == '#' && string.substring(offset + 1, offset + 4).equalsIgnoreCase("adm")) { // Yellow Crown
                    spriteClip4(x - 12, y - 16, 30, 20, 2339, -256, 0, 0, false);
                    x += 14;
                    offset += 4;
                } else
                if (string.charAt(offset) == '#' && offset + 4 < string.length() && string.charAt(offset + 4) == '#' && string.substring(offset + 1, offset + 4).equalsIgnoreCase("mod")) { // Grey Crown
                    spriteClip4(x - 12, y - 16, 30, 20, 2339, -2302756, 0, 0, false);
                    x += 14;
                    offset += 4;
                } else
                if (string.charAt(offset) == '#' && offset + 4 < string.length() && string.charAt(offset + 4) == '#' && string.substring(offset + 1, offset + 4).equalsIgnoreCase("pmd")) { // Green Crown
                    spriteClip4(x - 12, y - 16, 30, 20, 2339, -13382656, 0, 0, false);
                    x += 14;
                    offset += 4;
		    } else
                if (string.charAt(offset) == '#' && offset + 4 < string.length() && string.charAt(offset + 4) == '#' && string.substring(offset + 1, offset + 4).equalsIgnoreCase("evt")) { // Blue Crown
                    spriteClip4(x - 12, y - 16, 30, 20, 2339, -10245124, 0, 0, false);
                    x += 14;
                    offset += 4;
		    } else
		    if ((string.charAt(offset) == '#') && (offset + 4 < string.length()) && (string.charAt(offset + 4) == '#') && (string.substring(offset + 1, offset + 4).equalsIgnoreCase("dev"))) { // Red Crown
          		   spriteClip4(x - 12, y - 16, 30, 20, 2339, 13369344, 0, 0, false);
          		   x += 14;
              	   offset += 4;
		    } else
		    if ((string.charAt(offset) == '#') && (offset + 4 < string.length()) && (string.charAt(offset + 4) == '#') && (string.substring(offset + 1, offset + 4).equalsIgnoreCase("pnk"))) { // Pink Crown
          		   spriteClip4(x - 12, y - 16, 30, 20, 2339, 16711935, 0, 0, false);
          		   x += 14;
              	   offset += 4;
		    } else
        	    if ((string.charAt(offset) == '#') && (offset + 4 < string.length()) && (string.charAt(offset + 4) == '#') && (string.substring(offset + 1, offset + 4).equalsIgnoreCase("blk"))) { // Black Crown
          		   spriteClip4(x - 12, y - 16, 30, 20, 2339, 2500134, 0, 0, false);
         	 	   x += 14;
          		   offset += 4;
		    } else
		    if ((string.charAt(offset) == '#') && (offset + 4 < string.length()) && (string.charAt(offset + 4) == '#') && (string.substring(offset + 1, offset + 4).equalsIgnoreCase("rin"))) { // Rainbow Crown
			   colour = (int) (Math.random() * 16777215D);
			   spriteClip4(x - 12, y - 16, 30, 20, 2339, colour, 0, 0, false);
			   x += 14;
			   offset += 4;
		    } else
		    if ((string.charAt(offset) == '#') && (offset + 4 < string.length()) && (string.charAt(offset + 4) == '#') && (string.substring(offset + 1, offset + 4).equalsIgnoreCase("orn"))) { // Orange Crown
