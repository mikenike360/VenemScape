...
//                l7 = 1;
    ...
    private final void drawWelcomeBox() {
        ...
        j += 20;
        gameGraphics.drawText("Welcome to VenemScape " + currentUser, 256, j, 4, 0xffff00);
        j += 30;
        String s;
...
//                                showServerMessageBox = false;
    ...
    private final void makeLoginMenus() {
        ...
        int i = 40;
        menuWelcome.drawText(256, 200 + i, "Welcome to VenemScape", 4, true);
        menuWelcome.drawText(256, 215 + i, "For support please visit www.venemscape.com", 4, true);
